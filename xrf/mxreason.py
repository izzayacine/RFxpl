...
class MXReasoner:
    ...
    def __init__(self, encoding, target, solver='g3', oracle='int',
        ...
        for clid in encoding:
            ...
            self.formulas[clid] = encoding[clid].formula
...
#             for cl in encoding[clid].formula.hard:
...
#             for cl, wght in zip(encoding[clid].formula.soft,encoding[clid].formula.wght):
#                 self.formulas[clid].append(cl, weight=wght)            

#             self.formulas[clid].vmax =  encoding[clid].formula.vmax
#             self.formulas[clid].cost =  encoding[clid].formula.cost
